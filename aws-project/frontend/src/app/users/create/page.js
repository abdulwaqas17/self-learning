...
export default function AddUserPage() {
  ...
  const roles = [
    { value: 'user', label: 'Standard User', icon: User, color: 'from-gray-500 to-gray-600', desc: 'Basic access only' },
    { value: 'admin', label: 'Administrator', icon: Shield, color: 'from-red-500 to-red-600', desc: 'Full system access' },
    { value: 'manager', label: 'Manager', icon: Users, color: 'from-purple-500 to-purple-600', desc: 'Team management' },
    { value: 'branch-head', label: 'Branch Head', icon: Building, color: 'from-blue-500 to-blue-600', desc: 'Single branch access' },
    { value: 'area-manager', label: 'Area Manager', icon: Building, color: 'from-indigo-500 to-indigo-600', desc: 'Multiple branches' }
  ];
    ...
    <div>
      ...
      <div className="relative group">
        ...
        <input
          ...
          className={`w-full ${Icon ? 'pl-11' : 'pl-4'} pr-4 py-3 bg-white border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 ${
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-gray-600">Create a new user account with specific permissions</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm sticky top-8">
              <h3 className="text-lg font-bold text-gray-900 mb-6">Setup Process</h3>
                ...
                {sections.map((section, index) => (
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xs text-gray-500">Step {index + 1} of {sections.length}</div>
                    </div>
                  </button>
                ))}
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-blue-500 to-blue-600 rounded-full transition-all duration-500" style={{ width: '33%' }}></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Enter the basic details for the new user</p>
                    </div>
                  </div>
              ...
              {/* Profile Section */}
              <div className={`transition-all duration-300 ${activeSection === 'profile' ? 'block' : 'hidden'}`}>
                <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Upload profile picture and set permissions</p>
                    </div>
                  </div>
                  ...
                  <div className="mb-8">
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-600 mb-4">Upload a clear photo for identification</p>
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-gray-600 mb-6">Select the appropriate role for this user</p>
                      ...
                      {roles.map((role) => (
                        ...
                        >
                          ...
                          <div className="flex items-start gap-3">
                            <div className={`p-2.5 rounded-lg bg-gradient-to-r ${role.color} shadow-sm`}>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <label className={`cursor-pointer rounded-xl border-2 p-5 transition-all duration-200 ${
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600 mt-1">User can immediately access the system</div>
                          </div>
                        </div>
                      </label>
                      ...
                      <label className={`cursor-pointer rounded-xl border-2 p-5 transition-all duration-200 ${
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <div className="font-bold text-gray-900">Inactive</div>
                            <div className="text-sm text-gray-600 mt-1">User access is disabled initially</div>
                          </div>
                        </div>
                      </label>
                    </div>
              ...
              {/* Security Section */}
              <div className={`transition-all duration-300 ${activeSection === 'security' ? 'block' : 'hidden'}`}>
                <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Set up password and additional information</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 mb-8">
                    ...
                    <p className="text-gray-600 mb-6">
                      Set a secure password for the user. Leave blank if you want to send an invitation email.
                    </p>
                      ...
                      <div className="mt-6">
                        ...
                        <div className="flex items-center gap-2 mt-3">
                          ...
                          <span className="text-xs text-gray-600">
                            {formData.password.length >= 8 ? 'Password meets security requirements' : 'Minimum 8 characters required'}
                          </span>
                        </div>
                      </div>
                    )}
